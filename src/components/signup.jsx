...
import ImageMake from "../assets/images/maker.webp";
import './signup.css';
        ...
        <div>
            ...
            <div className="form-signin m-auto mt-5">
                <form onSubmit={handleSubmit}>
                    <img className="mb-4" src={ImageMake} alt="" width="72" height="57" />
                    ...
                    <a href="/dashboard" className="btn btn-primary w-100 mb-3 py-2" type="submit">Sign Up</a>
                    <p className="mt-5 mb-3 text-body-secondary">© Make, Inc. 2024</p>
                </form>
            </div>
        </div>
    );
